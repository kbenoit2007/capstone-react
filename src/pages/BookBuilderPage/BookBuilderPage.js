...
function BookBuilderPage() {
  ...
  return (
    <div className="mainApp__container">
      ...
      {activePage === "BookDetailsPage" && (
        <BookDetailsPage
          selectCoverPageData={dataFromSelectCoverPage}
          onSelectClickNext={handleSelectClick}
        />
      )}
      {activePage === "ImageUpload" && (
        <ImageUpload
          bookDetailsData={dataFromBookDetailsPage}
          onBookDetailsClickNext={handleBookDetailsNext}
        />
      )}
      {activePage === "PreviewBook" && (
        <PreviewBook imageUploadData={dataFromImageUpload} />
      )}
    </div>
  );
}
